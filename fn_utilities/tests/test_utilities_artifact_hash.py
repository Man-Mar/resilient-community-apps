...
import pytest
from mock_artifact import AttachmentMock
...
def call_artifact_hash_function(circuits, function_params, timeout=10):
...
class TestAttachmentHash:
    """ Tests for the artifact_hash function"""
    ...
    @pytest.mark.parametrize("incident_id, artifact_id, expected_result", [
        (123, None, 1, {"md5": "6c41093b2d21a8d211bef483aeb76aa9"}),            # md5 of 1st in mock_artifact.py
        (123, None, 2, {"sha1": "9f96227572cb1f5dae3ab914f8738c1f3734e841"})    # sha1 of 2nd in mock_artifact.py
    ])
    def test_success(self, circuits_app, incident_id, artifact_id, expected_result):
        ...
        result = call_artifact_hash_function(circuits_app, function_params)
